...
import { UniclyXUnicVault } from "../typechain-hardhat/UniclyXUnicVault";
...
export let uniclyXUnicVault: UniclyXUnicVault;
...
async function doInitState() {
  ...
  uniclyXUnicVault = await deployArtifact<UniclyXUnicVault>("UniclyXUnicVault", { from: deployer }, []);
